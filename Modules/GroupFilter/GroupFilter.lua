...
local function MakeSectionHeader(parent, text, yOff)
    local T  = ns.Theme
    local fs = parent:CreateFontString(nil, "OVERLAY", "SystemFont_Small")
    fs:SetPoint("TOPLEFT", parent, "TOPLEFT", PAD, yOff)
    fs:SetText(text)
    fs:SetTextColor(T.textDim[1], T.textDim[2], T.textDim[3], 1)
...
local function BuildPanel()
    ...
    div:SetColorTexture(T.textDim[1], T.textDim[2], T.textDim[3], 0.15 * 0.5)
